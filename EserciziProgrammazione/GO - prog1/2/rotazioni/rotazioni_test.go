...
che ruota il rettangolo r intorno al suo vertice pLL di 90 gradi
in senso orario se dir è 'R' e in senso antiorario se dir è 'L'.
Per esempio, ruotando il rettangolo qui sopra in direzione 'L',
il rettangolo diventa quello della figura qui sotto (P1 del
vecchio rettangolo corrisponde a P2 del nuovo).
...
- un ***metodo***  da applicare a Rectangle
  String() string
  che restituisce una riga di descrizione del rettangolo nel
	seguente formato: ((P1.x,P1.y) (P3.x,P3.y))
  (cioè ad es. "((2,3) (7,13))"
